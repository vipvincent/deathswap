...
execute if score *end deathswap.timer matches 100 if score *language deathswap.setting matches 2 run title @a subtitle {"text": "§b感謝遊玩"}
...
execute if score *end deathswap.timer matches 200 if score *language deathswap.setting matches 2 run title @a subtitle {"text": "§b製作：vipvincent"}
