#return
execute if score mode deathswap.setting matches 1 if score language deathswap.setting matches 1 run tellraw @a {"text": "§cSolo mode does not support this setting!"}
