...
#中文
execute if score *language deathswap.setting matches 2 if score *weather_cycle deathswap.setting matches 0 run tellraw @a [{"text": "§6死亡交換§7 | §r"},{"text": "§f天氣變化已§a開啟"}]
execute if score *language deathswap.setting matches 2 if score *weather_cycle deathswap.setting matches 1 run tellraw @a [{"text": "§6死亡交換§7 | §r"},{"text": "§f天氣變化已§c關閉"}]
