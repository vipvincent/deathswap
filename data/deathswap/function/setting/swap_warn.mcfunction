...
execute if score language deathswap.setting matches 1 if score swap_warn deathswap.setting matches 3 run tellraw @a [{"text": "§6Death Swap§7 | §r"},{"text": "§fSwap warn is set §a3s"}]
...
execute if score language deathswap.setting matches 2 if score swap_warn deathswap.setting matches 3 run tellraw @a [{"text": "§6死亡交換§7 | §r"},{"text": "§f交換警告已設定為§a3秒"}]
