...
{"text": "§6Death Swap 死亡交換","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"},"hover_event":{"action":"show_text","value":"Click here to §aModrinth\n§f點擊此處前往 §aModrinth"}},{"text": " §ev3.5"}\
]
execute unless data storage deathswap:storage_main {install:1b} run tellraw @a [\
{"text": "§r- "},\
...
{"text": "§6Death Swap","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"},"hover_event":{"action":"show_text","value":"Click here to §aModrinth\n§f點擊此處前往 §aModrinth"}},{"text": " §ev3.5"}\
]
#install/en/notadmin
...
{"text": "§6死亡交換","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"},"hover_event":{"action":"show_text","value":"Click here to §aModrinth\n§f點擊此處前往 §aModrinth"}},{"text": " §ev3.5"}\
]
#install/tw/notadmin
