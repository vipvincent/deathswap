#load_text
#not install
execute unless data storage deathswap:status {install:1b} run tellraw @a [{"text": "§6Death Swap 死亡交換","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"}},{"text": " §ev3.4"}]
...
#install/en
execute if score language deathswap.setting matches 1 run tellraw @a [{"text": "§6Death Swap","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"}},{"text": " §ev3.4"}]
#install/en/notadmin
...
[{"text": "[","color":"yellow","click_event": {"action": "run_command","command": "/function deathswap:ui/language"},"hover_event": {"action": "show_text","value": "§eClick here or type command 點此或輸入以下指令\n§d/function deathswap:ui/language \n§c[OP players OP 玩家]\n§d/trigger deathswap set 10 \n§a[Admin 管理員權限]"}},{"translate": "narrator.button.language"},{"text": "]"}]," ",\
...
#install/tw
execute if score language deathswap.setting matches 2 run tellraw @a [{"text": "§6死亡交換","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"}},{"text": " §ev3.4"}]
#install/tw/notadmin
