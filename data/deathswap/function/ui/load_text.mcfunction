#load_text
#not install
execute unless data storage deathswap:status {install:1b} run tellraw @a [{"text": "§6Death Swap 死亡交換","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"}},{"text": " §ev3.1"}]
...
#install_stage
execute if data storage deathswap:status {install_stage:1b} run tellraw @a [{"text": "§6Death Swap 死亡交換","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"}},{"text": " §ev3.1"}]
...
#install/en
execute if score language deathswap.setting matches 1 run tellraw @a [{"text": "§6Death Swap","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"}},{"text": " §ev3.1"}]
#install/en/notadmin
...
#install/tw
execute if score language deathswap.setting matches 2 run tellraw @a [{"text": "§6死亡交換","click_event": {"action": "open_url","url": "https://modrinth.com/datapack/deathswap"}},{"text": " §ev3.1"}]
#install/tw/notadmin
