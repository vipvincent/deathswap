...
#tip
item replace entity @a[tag=notadmin] inventory.14 with command_block[custom_data={ui:1b},custom_name={"text":"設定介面？","italic":false},lore=['§e進入設定介面需要管理員權限','§e如果你是OP，請切換至創造模式','§e或輸入"/tag @s add admin"來獲得管理員權限']]
