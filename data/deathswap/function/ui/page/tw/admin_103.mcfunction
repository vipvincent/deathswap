...
item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=103}] inventory.26 with nautilus_shell[custom_data={ui:1b},item_name={"text":"§e重設競技場設定"}]
...
#arena.shrink
execute if score arena.shrink deathswap.setting matches 0 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=103}] inventory.14 with lead[custom_data={ui:1b},item_name={"text":"§a競技場縮圈：開啟"},enchantment_glint_override=true]
execute if score arena.shrink deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=103}] inventory.14 with lead[custom_data={ui:1b},item_name={"text":"§c競技場縮圈：關閉"}]
