...
#difficulty
execute if score *difficulty deathswap.setting matches 0 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.0 with player_head[custom_data={ui:1b},custom_name={"text":"§a難度：和平","italic":false},lore=['§7遊戲難度'],profile={name:"MHF_Cow"},tooltip_display={hidden_components:["profile"]}]
...
#spawn_monsters
execute if score *spawn_monsters deathswap.setting matches 0 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.1 with stick[item_model="creeper_spawn_egg",custom_data={ui:1b},custom_name={"text":"§a怪物生成：開啟"},lore=['§7是否生成怪物，部分怪物除外'],enchantment_glint_override=true]
execute if score *spawn_monsters deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.1 with stick[item_model="creeper_spawn_egg",custom_data={ui:1b},custom_name={"text":"§c怪物生成：關閉"},lore=['§7是否生成怪物，部分怪物除外']]
...
#wather_cycle
execute if score *weather_cycle deathswap.setting matches 0 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.19 with wind_charge[custom_data={ui:1b},custom_name={"text":"§a天氣變化：開啟"},lore=['§7天氣是否變化'],enchantment_glint_override=true]
execute if score *weather_cycle deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.19 with wind_charge[custom_data={ui:1b},custom_name={"text":"§c天氣變化：關閉"},lore=['§7天氣是否變化']]
...
#tool
execute if score *tool deathswap.setting matches 0 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.11 with stick[item_model="wooden_pickaxe",custom_data={ui:1b},custom_name={"text":"§c起始工具：關閉"},lore=['§7遊戲開始後是否要給予玩家起始工具']]
execute if score *tool deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.11 with stick[item_model="wooden_pickaxe",custom_data={ui:1b},custom_name={"text":"§a起始工具：木製工具"},lore=['§7遊戲開始後是否要給予玩家起始工具'],enchantment_glint_override=true]
execute if score *tool deathswap.setting matches 2 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.11 with stick[item_model="stone_pickaxe",custom_data={ui:1b},custom_name={"text":"§a起始工具：石製工具"},lore=['§7遊戲開始後是否要給予玩家起始工具'],enchantment_glint_override=true]
execute if score *tool deathswap.setting matches 3 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.11 with stick[item_model="copper_pickaxe",custom_data={ui:1b},custom_name={"text":"§a起始工具：銅製工具"},lore=['§7遊戲開始後是否要給予玩家起始工具'],enchantment_glint_override=true]
execute if score *tool deathswap.setting matches 4 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.11 with stick[item_model="iron_pickaxe",custom_data={ui:1b},custom_name={"text":"§a起始工具：鐵製工具"},lore=['§7遊戲開始後是否要給予玩家起始工具'],enchantment_glint_override=true]
execute if score *tool deathswap.setting matches 5 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.11 with stick[item_model="golden_pickaxe",custom_data={ui:1b},custom_name={"text":"§a起始工具：金製工具"},lore=['§7遊戲開始後是否要給予玩家起始工具'],enchantment_glint_override=true]
execute if score *tool deathswap.setting matches 6 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.11 with stick[item_model="diamond_pickaxe",custom_data={ui:1b},custom_name={"text":"§a起始工具：鑽石工具"},lore=['§7遊戲開始後是否要給予玩家起始工具'],enchantment_glint_override=true]
execute if score *tool deathswap.setting matches 7 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.11 with stick[item_model="netherite_pickaxe",custom_data={ui:1b},custom_name={"text":"§a起始工具：獄髓工具"},lore=['§7遊戲開始後是否要給予玩家起始工具'],enchantment_glint_override=true]

#armor
execute if score *armor deathswap.setting matches 0 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.12 with stick[item_model="leather_chestplate",custom_data={ui:1b},custom_name={"text":"§c起始裝備：關閉"},lore=['§7遊戲開始後是否要給予玩家起始裝備']]
execute if score *armor deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.12 with stick[item_model="leather_chestplate",custom_data={ui:1b},custom_name={"text":"§a起始裝備：皮革裝備"},lore=['§7遊戲開始後是否要給予玩家起始裝備'],enchantment_glint_override=true]
execute if score *armor deathswap.setting matches 2 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.12 with stick[item_model="copper_chestplate",custom_data={ui:1b},custom_name={"text":"§a起始裝備：銅製裝備"},lore=['§7遊戲開始後是否要給予玩家起始裝備'],enchantment_glint_override=true]
execute if score *armor deathswap.setting matches 3 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.12 with stick[item_model="chainmail_chestplate",custom_data={ui:1b},custom_name={"text":"§a起始裝備：鎖鏈裝備"},lore=['§7遊戲開始後是否要給予玩家起始裝備'],enchantment_glint_override=true]
execute if score *armor deathswap.setting matches 4 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.12 with stick[item_model="iron_chestplate",custom_data={ui:1b},custom_name={"text":"§a起始裝備：鐵製裝備"},lore=['§7遊戲開始後是否要給予玩家起始裝備'],enchantment_glint_override=true]
execute if score *armor deathswap.setting matches 5 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.12 with stick[item_model="golden_chestplate",custom_data={ui:1b},custom_name={"text":"§a起始裝備：黃金裝備"},lore=['§7遊戲開始後是否要給予玩家起始裝備'],enchantment_glint_override=true]
execute if score *armor deathswap.setting matches 6 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.12 with stick[item_model="diamond_chestplate",custom_data={ui:1b},custom_name={"text":"§a起始裝備：鑽石裝備"},lore=['§7遊戲開始後是否要給予玩家起始裝備'],enchantment_glint_override=true]
execute if score *armor deathswap.setting matches 7 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.12 with stick[item_model="netherite_chestplate",custom_data={ui:1b},custom_name={"text":"§a起始裝備：獄髓裝備"},lore=['§7遊戲開始後是否要給予玩家起始裝備'],enchantment_glint_override=true]
...
execute if score *swap_invincible deathswap.setting matches 5 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.13 with ender_eye[custom_data={ui:1b},custom_name={"text":"§a交換無敵：5秒"},lore=['§7交換時是否要給予抗性'],enchantment_glint_override=true] 5
...
#furnace
execute if score *furnace deathswap.setting matches 0 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.22 with stick[item_model="raw_iron",custom_data={ui:1b},custom_name={"text":"§c自動熔爐：關閉"},lore=['§7礦物和食物自動燒好']]
execute if score *furnace deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] inventory.22 with stick[item_model="iron_ingot",custom_data={ui:1b},custom_name={"text":"§a自動熔爐：開啟"},lore=['§7礦物和食物自動燒好'],enchantment_glint_override=true]
