...
#choose_team
execute if score *team_choose deathswap.setting matches 0 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=2}] inventory.23 with slime_ball[custom_data={ui:1b},custom_name={"text":"§c自由選隊：關閉"},lore=['§7開啟此功能才能讓玩家自己選擇隊伍']]
execute if score *team_choose deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=2}] inventory.23 with slime_ball[custom_data={ui:1b},custom_name={"text":"§a自由選隊：開啟"},lore=['§7開啟此功能才能讓玩家自己選擇隊伍'],enchantment_glint_override=true]
