...
loot replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=101}] inventory.13 loot deathswap:ui/page/tw/gmchange.survival_time
...
loot replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=101}] inventory.22 loot deathswap:ui/page/tw/gmchange.creative_time
