...
#team collisionRule
execute if score mode deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=2}] inventory.20 with barrier[custom_data={ui:1b},custom_name={"text":"§cSolo mode does not support this setting!"}]
...
#team friendlyFire
execute if score mode deathswap.setting matches 1 run item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=2}] inventory.21 with barrier[custom_data={ui:1b},custom_name={"text":"§cSolo mode does not support this setting!"}]
