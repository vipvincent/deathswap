...
#info
item replace entity @a[tag=admin,tag=!creative,scores={deathswap.ui_page=0}] inventory.26 with player_head[custom_data={ui:1b},custom_name={"text":"§eAbout Death Swap"},profile={name:vipvincent},tooltip_display={hidden_components:["profile"]}]
#reset win scores
