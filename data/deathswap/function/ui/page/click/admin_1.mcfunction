...
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.1 *[custom_data={ui:1b}] run function deathswap:setting/spawn_monsters
...
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.22 *[custom_data={ui:1b}] run function deathswap:setting/furnace
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.23 *[custom_data={ui:1b}] run function deathswap:setting/start_pos
...
execute if score *swap_invincible deathswap.setting matches 5 as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.13 *[custom_data={ui:1b},count=5] run function deathswap:setting/swap_invincible
...
execute if score *swap_warn deathswap.setting matches 3 as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.14 *[custom_data={ui:1b},count=3] run function deathswap:setting/swap_warn
...
#team setting
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.20 *[custom_data={ui:1b}] run function deathswap:setting/team_collisionrule
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.21 *[custom_data={ui:1b}] run function deathswap:setting/team_friendlyfire

#effect
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.6 *[custom_data={ui:1b}] run function deathswap:setting/saturation
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.15 *[custom_data={ui:1b}] run function deathswap:setting/night_vision
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.24 *[custom_data={ui:1b}] run function deathswap:setting/glowing

#inventory_limit
execute if score *inventory_limit deathswap.setting matches 37 as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.7 *[custom_data={ui:1b},count=37] run function deathswap:setting/inventory_limit
execute if score *inventory_limit deathswap.setting matches 28 as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.7 *[custom_data={ui:1b},count=28] run function deathswap:setting/inventory_limit
execute if score *inventory_limit deathswap.setting matches 19 as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.7 *[custom_data={ui:1b},count=19] run function deathswap:setting/inventory_limit
execute if score *inventory_limit deathswap.setting matches 10 as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.7 *[custom_data={ui:1b},count=10] run function deathswap:setting/inventory_limit
execute if score *inventory_limit deathswap.setting matches 2 as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=1}] unless items entity @s inventory.7 *[custom_data={ui:1b},count=2] run function deathswap:setting/inventory_limit