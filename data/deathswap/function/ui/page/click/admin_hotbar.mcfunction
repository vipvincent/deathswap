...
execute as @a[tag=admin,tag=!creative] unless items entity @s hotbar.1 *[custom_data={ui:1b}] run function deathswap:prepare/tpall_here
...
execute as @a[tag=admin,tag=!creative,scores={deathswap.carrot_right_click=1}] unless score @s deathswap.sneak matches 1.. if items entity @s weapon.mainhand carrot_on_a_stick[custom_data={ui:1b},item_model="ender_pearl"] run function deathswap:prepare/tpall_here
execute as @a[tag=admin,tag=!creative,scores={deathswap.carrot_right_click=1,deathswap.sneak=1}] if items entity @s weapon.mainhand carrot_on_a_stick[custom_data={ui:1b},item_model="ender_pearl"] run function deathswap:prepare/tpall_lobby
