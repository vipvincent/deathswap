...
#team
execute if score team_choose deathswap.setting matches 1 if score mode deathswap.setting matches 1 as @a[tag=!creative] unless items entity @s hotbar.2 *[custom_data={ui:1b}] run function deathswap:ui/team/join/solo
execute if score team_choose deathswap.setting matches 1 if score mode deathswap.setting matches 1 as @a[tag=!creative] unless items entity @s hotbar.3 *[custom_data={ui:1b}] run function deathswap:ui/team/join/solo
execute if score team_choose deathswap.setting matches 1 if score mode deathswap.setting matches 1 as @a[tag=!creative] unless items entity @s hotbar.5 *[custom_data={ui:1b}] run function deathswap:ui/team/join/solo
execute if score team_choose deathswap.setting matches 1 if score mode deathswap.setting matches 1 as @a[tag=!creative] unless items entity @s hotbar.6 *[custom_data={ui:1b}] run function deathswap:ui/team/join/solo

execute if score team_choose deathswap.setting matches 1 if score mode deathswap.setting matches 2 as @a[tag=!creative] unless items entity @s hotbar.2 *[custom_data={ui:1b}] run function deathswap:ui/team/join/red
execute if score team_choose deathswap.setting matches 1 if score mode deathswap.setting matches 2 as @a[tag=!creative] unless items entity @s hotbar.3 *[custom_data={ui:1b}] run function deathswap:ui/team/join/blue
execute if score team_choose deathswap.setting matches 1 if score mode deathswap.setting matches 2 as @a[tag=!creative] unless items entity @s hotbar.5 *[custom_data={ui:1b}] run function deathswap:ui/team/join/yellow
execute if score team_choose deathswap.setting matches 1 if score mode deathswap.setting matches 2 as @a[tag=!creative] unless items entity @s hotbar.6 *[custom_data={ui:1b}] run function deathswap:ui/team/join/green
...
#right
execute as @a[tag=!creative,scores={deathswap.carrot_right_click=1}] if items entity @s weapon.mainhand carrot_on_a_stick[custom_data={ui:1b},item_model="potion",potion_contents={custom_color:43520}] run function deathswap:ui/team/join/solo
