...
execute as @a[tag=admin,tag=!creative,scores={deathswap.ui_page=102}] unless items entity @s inventory.12 *[custom_data={ui:1b}] run function deathswap:setting/killer/eliminated_alert
