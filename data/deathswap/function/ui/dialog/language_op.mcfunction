#--------------------------------------------------
#Death Swap
#data/deathswap/function/ui/dialog/language_op.mcfunction
#
#Made by vipvincent
#--------------------------------------------------
...
dialog show @s {\
    ...
    "actions":[\
        {\
            ...
            "action": {"type":"run_command","command":"/function deathswap:setting/language/en"}\
        },\
        {\
            "width": 200,\
            "label": {"text":"繁體中文","color": "aqua"},\
            "tooltip": {"text":"點此設定語言為繁體中文"},\
            "action": {"type":"run_command","command":"/function deathswap:setting/language/zhtw"}\
        }\
    ]\
}