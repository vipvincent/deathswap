...
execute if score game deathswap.status matches 0 if score language deathswap.setting matches 2 run tellraw @s[gamemode=creative] [{"text": "§d你已獲得管理員權限，打開設定書即可進入設定介面"}]
execute if score game deathswap.status matches 0 run tellraw @s ""
...
execute if score game deathswap.status matches 0 if score language deathswap.setting matches 1 run execute as @a[gamemode=!creative] run title @s subtitle [{"text": "§fOpen your inventory to enter the setting menu"}]
execute if score game deathswap.status matches 0 if score language deathswap.setting matches 1 run execute as @a[gamemode=creative] run title @s subtitle [{"text": "§fOpen Setting Book to enter the setting menu"}]
...
execute if score game deathswap.status matches 0 if score language deathswap.setting matches 2 run execute as @a[gamemode=creative] run title @s subtitle [{"text": "§f打開設定書即可進入設定介面"}]
