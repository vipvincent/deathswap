...
#bossbar
function deathswap:play/arena/boosbar
...
#wait sound
execute if score *arena deathswap.status matches 1 if score *arena deathswap.timer matches 100 as @a at @s run playsound ui.button.click master @s ~ ~ ~
execute if score *arena deathswap.status matches 1 if score *arena deathswap.timer matches 120 as @a at @s run playsound ui.button.click master @s ~ ~ ~
