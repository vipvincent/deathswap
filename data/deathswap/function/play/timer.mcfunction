...
execute if score tick deathswap.timer matches 20 if score gmchange deathswap.setting matches 1 if score gmchange_wait deathswap.timer matches ..0 run scoreboard players remove gmchange deathswap.timer 1
execute if score tick deathswap.timer matches 20 if score gmchange deathswap.setting matches 1 if score gmchange_wait deathswap.timer matches 1.. run scoreboard players remove gmchange_wait deathswap.timer 1

#random_effect
execute if score tick deathswap.timer matches 20 if score random_effect deathswap.setting matches 1 run scoreboard players remove random_effect deathswap.timer 1

#arena
execute if score tick deathswap.timer matches 20 if score arena deathswap.status matches 0 run scoreboard players remove arena deathswap.timer 1
