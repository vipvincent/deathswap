...
$execute if score language deathswap.setting matches 1 run bossbar set deathswap:random_effect name [{"text":"§fRandom Effect: "},{"translate":"effect.minecraft.$(effect)"},{"text":"§f | Next in "},{"score":{"name":"random_effect","objective":"deathswap.timer"}},{"text":"s"}]
