#--------------------------------------------------
#Death Swap
#data/deathswap/function/phase/preparation/tick.mcfunction
#
#Made by vipvincent
#--------------------------------------------------
...
#actionbar
execute if score *language deathswap.setting matches 1 run function deathswap:ui/actionbar/en/preparation
execute if score *language deathswap.setting matches 2 run function deathswap:ui/actionbar/tw/preparation
