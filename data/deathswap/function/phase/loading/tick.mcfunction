#--------------------------------------------------
#Death Swap
#data/deathswap/function/phase/loading/tick.mcfunction
#
#Made by vipvincent
#--------------------------------------------------
...
#title & sound
function deathswap:phase/loading/title

#gamemode
execute if score *loading deathswap.timer matches 1..39 run gamemode survival @a 
execute if score *loading deathswap.timer matches 40..400 run gamemode survival @a[tag=player]
...
#2s setting
execute if score *loading deathswap.timer matches 40 run function deathswap:phase/loading/setting

#3s teleport
execute if score *loading deathswap.timer matches 61 run function deathswap:phase/loading/teleport

#20s
execute if score *loading deathswap.timer matches 400 run function deathswap:phase/gameplay/start
