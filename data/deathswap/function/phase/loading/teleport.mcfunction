#--------------------------------------------------
#Death Swap
#data/deathswap/function/phase/loading/teleport.mcfunction
#
#Made by vipvincent
#--------------------------------------------------
...
#---
#arena
execute if score *arena deathswap.setting matches 1 if score *arena.start deathswap.setting matches 0 run return run function deathswap:phase/gameplay/arena/tp_border
