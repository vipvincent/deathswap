#--------------------------------------------------
#Death Swap
#data/deathswap/function/phase/gameplay/start.mcfunction
#
#Made by vipvincent
#--------------------------------------------------

#get swap_time
function deathswap:phase/gameplay/swap/swap_time
...
#status
scoreboard players set *game_phase deathswap.status 2
...
#give_item
function deathswap:phase/gameplay/start_item
...
execute if score *arena deathswap.setting matches 1 if score *arena.start deathswap.setting matches 0 if score *arena.shrink deathswap.setting matches 1 run function deathswap:phase/gameplay/arena/shrink_wait

#random_effect
execute if score *random_effect deathswap.setting matches 1 run function deathswap:phase/gameplay/random_effect/random

#killer
execute if score *mode deathswap.setting matches 1 if score *killer deathswap.setting matches 1 run schedule function deathswap:phase/gameplay/killer/choose_killer 5s
