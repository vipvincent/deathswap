#--------------------------------------------------
#Death Swap
#data/deathswap/function/phase/gameplay/swap/solo/main.mcfunction
#
#Made by vipvincent
#--------------------------------------------------

#assign_id
execute as @a[tag=player,sort=random] run function deathswap:phase/gameplay/swap/assign_id

#pos
execute as @a[tag=player] run function deathswap:phase/gameplay/swap/solo/pos
...
#tp
execute as @a[tag=player] run function deathswap:phase/gameplay/swap/solo/tp
