#--------------------------------------------------
#Death Swap
#data/deathswap/function/phase/gameplay/swap/team/main.mcfunction
#
#Made by vipvincent
#--------------------------------------------------

#pos
execute as @a[team=red,tag=player] at @s run function deathswap:phase/gameplay/swap/team/pos/red
execute as @a[team=blue,tag=player] at @s run function deathswap:phase/gameplay/swap/team/pos/blue
execute as @a[team=green,tag=player] at @s run function deathswap:phase/gameplay/swap/team/pos/green
execute as @a[team=yellow,tag=player] at @s run function deathswap:phase/gameplay/swap/team/pos/yellow
...
#random assign_id
execute as @e[tag=pos,tag=calculated,sort=random] run function deathswap:phase/gameplay/swap/assign_id

#target
execute as @e[tag=pos,tag=calculated] run function deathswap:phase/gameplay/swap/team/target
...
#---
#tp
execute as @a[team=red,tag=player] run function deathswap:phase/gameplay/swap/team/tp/red
execute as @a[team=blue,tag=player] run function deathswap:phase/gameplay/swap/team/tp/blue
execute as @a[team=green,tag=player] run function deathswap:phase/gameplay/swap/team/tp/green
execute as @a[team=yellow,tag=player] run function deathswap:phase/gameplay/swap/team/tp/yellow
