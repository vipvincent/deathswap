#--------------------------------------------------
#Death Swap
#data/deathswap/function/phase/gameplay/swap/main.mcfunction
#
#Made by vipvincent
#--------------------------------------------------
...
#---
#mode
execute if score *mode deathswap.setting matches 0 run function deathswap:phase/gameplay/swap/solo/main
execute if score *mode deathswap.setting matches 1 run function deathswap:phase/gameplay/swap/team/main
...
#gmchange pause
function deathswap:phase/gameplay/gmchange/pause