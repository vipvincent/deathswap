#--------------------------------------------------
#Death Swap
#data/deathswap/function/phase/gameplay/random_effect/random.mcfunction
#
#Made by vipvincent
#--------------------------------------------------
...
#disable effect
execute if score *random_effect.effect deathswap.status matches 7 run return run function deathswap:phase/gameplay/random_effect/random
...
#---
#effect
function deathswap:phase/gameplay/random_effect/effect with storage deathswap:temp random_effect